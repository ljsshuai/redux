            ...
            <div className="navbar-default navbar-side" style={{zIndex:'999',top:'0'}}>
                <div className="sidebar-collapse">
                    <ul className="nav">
                        ...
                        <li className="active" >
                            <NavLink exact activeClassName="activemenu" to="/" style={{padding:'18px 44px'}}>
                                <i className="glyphicon glyphicon-home"></i><span>首页</span></NavLink>
                        </li>
                        <li className="active">
                            <NavLink exact activeClassName="activemenu" to="/regulation" style={{padding:'18px 44px'}}>
                               <i className="glyphicon glyphicon-folder-open"></i>
                                <span>政策法规</span>
                            </NavLink>
                        </li>
                        <li className="active">
                            <NavLink exact activeClassName="activemenu" to="/filmtelevisionrecord" style={{padding:'18px 44px'}}>
                               <i className="glyphicon glyphicon-film"></i>
                                <span>影视备案</span>
                            </NavLink>
                        </li>
                        <li className="nav_left_active">
                            <NavLink exact activeClassName="activemenu" to="/entertainment_business" style={{padding:'18px 44px'}}>
                               <i className="glyphicon glyphicon-th-list"></i>
                                <span>文娱企业库</span>
                            </NavLink>
                        </li>
                        <li className="active">
                            <NavLink exact activeClassName="activemenu" to="/user" style={{padding:'18px 44px'}}>
