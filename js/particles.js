...
window.requestAnimFrame = (function(){
  return  window.requestAnimationFrame ||
    ...
    function(callback){
        // console.log(window.setTimeout(callback, 1000 / 60))
...
window.particlesJS = function(tag_id, params){
  ...
  console.log(window,document.getElementsByTagName('canvas')[0])
  ...
  /* append canvas */
  console.log(document.getElementById(tag_id),tag_id)
